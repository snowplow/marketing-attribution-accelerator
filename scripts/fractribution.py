...
class Fractribution(object):
  ...
  def __init__(self, query_job):
    ...
    print('building tuple summary...', query_job)
  ...
  #   # TODO: this could probably get converted to SQL...
  #     self,
  #     client,
  ...
  #   print('things might work by here:')
  #   x = bytesio
  #   print(x.read())
  #   print('after this it will break')
  #   x.seek(0)
  #   bytesio.seek(0)
